...
**Research question 1:**
What is the relationship between residential segregation (continuous variable) and juvenile arrests (continuous variable)? How is this relationship affected by the county's median household income (categorical variable, where 0=below national average, 1=above national average)?
...
texas_full <- read.csv('https://github.com/rrandev03/Practical-Data-Science/raw/refs/heads/main/Texas.csv', skip=1)
#colnames(texas_full)
```

```{r}
texas <- texas_full[c('FIPS', 'State', 'County', "Segregation.Index", "Spending.per.Pupil", "School.Funding.Adequacy", "Segregation.Index.1", "Juvenile.Arrest.Rate")]
head(texas)
```
```{r}
texas <- texas |> 
